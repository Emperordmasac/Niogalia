          ...
          <div className={styles.footer_box_up_left}>
            <div className={styles.footer_box_up_left_details}>
              ...
              <p>
                ...
                products drops, and tips and tricks for navigating the world of
                commerce.
              </p>
            </div>
            <div className={styles.footer_box_up_left_form}>
              <div className={styles.footer_box_up_left_form_input_box}>
                <input type="text" placeholder="Your email address" />
              </div>
              <div className={styles.footer_box_up_left_form_button}>
                <Button name="Sign up" style={styles.footer_button} />
              </div>
            </div>
          </div>
          <div className={styles.footer_box_up_right}>
            <div className={styles.footer_box_up_right_social_box}>
              <div className={styles.footer_box_up_right_social_title}>
        ...
        <div className={styles.footer_box_down}>
          <div className={styles.footer_box_down_box}>
            <div className={styles.footer_box_down_box_left}>
              ...
              <div className={styles.footer_box_down_box_left_details}>
                <h3>Niogalia</h3>
                <p>
                  The world’s first and largest digital e-commerce for all
                  things imaginable . Buy, sell, and discover exclusive items.
                </p>
              </div>
            </div>
          </div>
