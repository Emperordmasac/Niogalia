            ...
            <div className={styles.single_product_container}>
                <div className="container">
                    <div className={styles.single_product_container_box}>
                        ...
                        <div
                            className={styles.single_product_container_box_left}
                        >
                        ...
                        <div
                            className={
                                styles.single_product_container_box_right
                            }
                        >
                            <p className={styles.single_product_spec}>
                                {item[0].specs}
                            </p>
                            ...
                            <div className={styles.single_product_cta}>
                                ...
                                <button className={styles.single_cta_buy}>
                                    buy now
                                </button>
                            </div>
                        </div>
                    ...
                    <div className={styles.single_full_specifications}>
                        <div className={styles.single_spec_container}>
                            <div className={styles.single_spec_title}>
                                Texture:
                            </div>
                            <div className={styles.single_spec_desc}>
                                {item[0].texture}
                            </div>
                        </div>
                        <div className={styles.single_spec_container}>
